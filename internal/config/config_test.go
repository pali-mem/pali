...
func TestDefaults(t *testing.T) {
	...
	require.Equal(t, "pali_memories", cfg.PGVector.Table)
	require.True(t, cfg.PGVector.AutoMigrate)
	require.Equal(t, 10, cfg.PGVector.MaxOpenConns)
	require.Equal(t, 5, cfg.PGVector.MaxIdleConns)
