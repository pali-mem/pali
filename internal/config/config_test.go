...
func TestDefaults(t *testing.T) {
	...
	require.False(t, cfg.Retrieval.AnswerTypeRoutingEnabled)
	require.False(t, cfg.Retrieval.EarlyRankRerankEnabled)
	require.False(t, cfg.Retrieval.TemporalResolverEnabled)
	...
	require.False(t, cfg.Retrieval.MultiHop.GraphSingletonInvalidation)
